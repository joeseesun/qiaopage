...
- Cloudflare and Vercel are planned, not implemented. Do not add deploy buttons or mark them supported until persistence, authorization, uploads, restart and recovery have passed on those platforms.
